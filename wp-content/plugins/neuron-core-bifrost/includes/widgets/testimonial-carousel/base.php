		...
		$this->add_control(
            ...
            [
                ...
                'fields' => [
					...
					[
                        'name' => 'title_url',
                        'label' => __('Title URL', 'neuron-core'),
						'type' => \Elementor\Controls_Manager::TEXT,
                    ],
				],
				'default' => [
							...
							<div class="m-neuron-testimonial__cite">
								<?php if ($slide['name']) : ?>
									<span class="m-neuron-testimonial__name">
										<?php if ( $slide['name_url'] ) : ?>
											<a href="<?php echo esc_url($slide['name_url']) ?>">
										<?php endif; ?>
										<?php echo esc_attr($slide['name']) ?>
										<?php if ( $slide['name_url'] ) : ?>
											</a>
										<?php endif; ?>
									</span>
