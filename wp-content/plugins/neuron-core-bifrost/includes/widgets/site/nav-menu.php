...
class NeuronNavMenu extends Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} nav.m-nav-menu--vertical > ul li.menu-item-has-children ul.sub-menu' => 'padding-{{VALUE}}: 1.8333333333rem',
				],
				'label_block' => false,
				'default' => 'left'
			]
		...
		$this->add_control(
			...
			[
				'label' => __('Active Class', 'neuron-core'),
				'type' => Controls_Manager::SWITCHER,
				'description' => __('Enable the active class on scroll, the menu item href should be the same with section id.', 'neuron-core'),
				'return_value' => 'yes',
				'default' => 'no',
				'prefix_class' => 'm-nav-menu--active-class-'
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .m-nav-menu--horizontal ul > li:hover > a:not(.menu-item-icon)' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}} !important; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--vertical ul > li:hover > a:not(.menu-item-icon)' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}} !important; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--mobile nav ul > li:hover > a:not(.menu-item-icon)' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}} !important; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .m-nav-menu--horizontal ul > li.menu-item.current_page_ancestor > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}} !important; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--horizontal ul > li.menu-item.current_page_item > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--vertical ul > li.menu-item.current_page_ancestor > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--vertical ul > li.menu-item.current_page_item > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--mobile ul > li.menu-item.current_page_ancestor > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} .m-nav-menu--mobile ul > li.menu-item.current_page_item > a' => 'color: {{VALUE}}; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} nav ul li.menu-item.menu-item-has-children > ul.sub-menu li.menu-item a:hover' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}} !important',
				],
				'separator' => 'after'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} nav ul li.menu-item-has-children > ul.sub-menu li.current-menu-item > a' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
					'{{WRAPPER}} nav ul li.menu-item-has-children > ul.sub-menu li.current_page_ancestor > a' => 'color: {{VALUE}} !important; -webkit-box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}}; box-shadow: inset 0 0 0 rgba(0, 0, 0, 0), 0 1px 0 {{VALUE}};',
				],
				'separator' => 'after'
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => ['px', 'rem'],
				'selectors' => [
					'{{WRAPPER}} nav ul li.menu-item-has-children > ul.sub-menu li:not(:last-of-type)' => 'margin-bottom: {{SIZE}}{{UNIT}}',
				]
			]
		);
